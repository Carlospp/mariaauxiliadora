...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { costo: @treatment.costo, descripcion: @treatment.descripcion, nombre: @treatment.nombre }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { costo: @treatment.costo, descripcion: @treatment.descripcion, nombre: @treatment.nombre }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
